...
namespace QabilHire.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819133000_AddResumes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QabilHire.Domain.Entities.CandidateProfile", b =>
                {
                    ...
                    b.Property<string>("Achievement").IsRequired().HasMaxLength(1000).HasColumnType("character varying(1000)");
                    b.Property<string>("CareerGoal").IsRequired().HasMaxLength(1000).HasColumnType("character varying(1000)");
                    b.Property<string>("Company").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<DateTime>("CreatedAtUtc").HasColumnType("timestamp with time zone");
                    b.Property<string>("CurrentRole").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<string>("Education").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<string>("ExperienceDuration").IsRequired().HasMaxLength(60).HasColumnType("character varying(60)");
                    b.Property<string>("ExperienceLevel").IsRequired().HasMaxLength(80).HasColumnType("character varying(80)");
                    b.Property<string>("GraduationYear").IsRequired().HasMaxLength(20).HasColumnType("character varying(20)");
                    b.Property<string>("Headline").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<string>("Industry").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<string>("Institution").IsRequired().HasMaxLength(160).HasColumnType("character varying(160)");
                    b.PrimitiveCollection<List<string>>("InterviewPreferences").IsRequired().HasColumnType("text[]");
                    ...
                    b.Property<string>("Location").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<string>("PortfolioUrl").HasMaxLength(500).HasColumnType("character varying(500)");
                    b.Property<string>("Qualification").IsRequired().HasMaxLength(160).HasColumnType("character varying(160)");
                    b.Property<string>("Responsibilities").IsRequired().HasMaxLength(2000).HasColumnType("character varying(2000)");
                    b.Property<string>("SkillLevel").IsRequired().HasMaxLength(40).HasColumnType("character varying(40)");
                    b.PrimitiveCollection<List<string>>("Skills").IsRequired().HasColumnType("text[]");
                    b.Property<string>("TargetRole").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
            ...
            modelBuilder.Entity("QabilHire.Domain.Entities.Resume", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uuid");
                    b.Property<string>("AnalysisJson").HasColumnType("text");
                    b.Property<string>("ContentType").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
                    b.Property<DateTime>("CreatedAtUtc").HasColumnType("timestamp with time zone");
                    b.Property<string>("ExtractedJson").HasColumnType("text");
                    b.Property<string>("Extension").IsRequired().HasMaxLength(20).HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("OriginalText").HasColumnType("text");
                    ...
                    b.Property<string>("StorageBucket").IsRequired().HasMaxLength(80).HasColumnType("character varying(80)");
                    b.Property<string>("StoragePath").IsRequired().HasMaxLength(500).HasColumnType("character varying(500)");
                    b.Property<DateTime?>("UpdatedAtUtc").HasColumnType("timestamp with time zone");
                    b.Property<Guid>("UserId").HasColumnType("uuid");
                    b.HasKey("Id");
                    b.HasIndex("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
            {
                b.HasOne("QabilHire.Infrastructure.Identity.ApplicationUser", null).WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
            });
            ...
            modelBuilder.Entity("QabilHire.Domain.Entities.CandidateProfile", b =>
            {
                b.HasOne("QabilHire.Infrastructure.Identity.ApplicationUser", null).WithOne().HasForeignKey("QabilHire.Domain.Entities.CandidateProfile", "UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
            });
